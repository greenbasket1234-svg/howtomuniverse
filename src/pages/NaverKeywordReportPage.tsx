...
export function NaverKeywordReportPage(){
  ...
  return <>
    ...
    {channel==='naver'&&new Set(visible.map(r=>r.keywordId||r.keyword)).size>=300&&<div className="card" style={{color:'#a35b00',background:'#fff7e6',borderColor:'#ffe4b3',marginBottom:12,padding:'10px 14px',fontSize:13}}>네이버는 키워드가 많으면 동기화 시간이 오래 걸려 <b>상위 300개까지만</b> 수집됩니다. 캠페인 분석·통합 홈의 합계보다 이 화면 합계가 적을 수 있어요.</div>}
