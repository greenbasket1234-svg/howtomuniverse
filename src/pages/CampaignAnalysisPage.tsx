...
const chLabel=(c:string)=>c==='meta'?'Meta':c==='naver'?'네이버':c;
const chClass=(c:string)=>c==='meta'?'home-ch-tag':c==='naver'?'home-ch-tag naver':'home-ch-tag';
