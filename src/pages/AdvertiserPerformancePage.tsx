...
const metricNames:Record<PerformanceMetric,string>={spend:'광고비',impressions:'노출',clicks:'클릭',leads:'DB/전환',revenue:'매출',ctr:'CTR',cpa:'CPA',roas:'ROAS',cpc:'CPC',cvr:'CVR'};
