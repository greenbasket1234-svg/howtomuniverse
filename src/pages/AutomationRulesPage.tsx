...
export function AutomationRulesPage(){
 const [rules,setRules]=useState<Rule[]>(()=>{try{const parsed=JSON.parse(localStorage.getItem('acc_rules')||'[]');return Array.isArray(parsed)?parsed:defaults}catch{return defaults}});
