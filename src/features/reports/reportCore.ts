...
export const BASE_ADVERTISERS = ['다방이사', '다시마전복수산', '서울우리아이치과', '온동물병원', '알에스컴퍼니', '운명백과', '완도군수산', '노멜', '웰컴투바베큐', 'RS컴퍼니', '세민관광', '디자인휴먼학원'];
...
export function inferReportType(advertiserName: string): ReportType {
  ...
  if (advertiserName.includes('전복') || advertiserName.includes('수산') || advertiserName.includes('노멜')) return 'revenue';
...
export const LEAD_SOURCE_RAW: SourceMap = {
  '메타': {
    leads: pad31([17,18,23,9,18,9,17,17,14,16,15,13,18,14,10,10,16,13,11,20,13]),
    clicks: pad31([75,84,84,74,118,79,86,90,72,80,81,91,92,82,80,75,91,58,98,87,74]),
    impressions: pad31([2706,2496,2479,2440,3705,2990,2569,2303,2577,2801,2951,3602,2886,2842,2713,2641,2825,2441,3401,3015,3027]),
    spend: pad31([68237,66837,62485,59521,84958,73742,69071,68742,64426,65914,62524,84556,76151,69215,65093,65957,70088,57781,82666,73975,69373]),
  },
  '당근': {
    leads: pad31([4,7,5,5,9,7,8,5,5,4,5,4]),
    clicks: pad31([158,149,150,155,179,170,174,160,161,148,182,131]),
    impressions: pad31([14788,11500,13976,12453,14690,12369,17753,16252,14871,14736,17217,13861]),
    spend: pad31([49910,51286,49471,49565,50165,50001,49839,50225,50055,49984,49736,32463]),
  },
  '네이버': {
    leads: pad31([5,7,3,4,0,10,3,6,7,5,4,1,6,6,4,2,4,1,2,3,4]),
    clicks: pad31([478,154,87,74,85,132,236,113,100,97,62,75,104,98,92,88,87,79,70,92,101]),
    impressions: pad31([16639,15255,13647,8804,35547,24977,18879,17975,15323,13024,9220,8388,14884,14572,18691,13744,11308,8689,9434,14975,14847]),
    spend: pad31([188603,131408,160529,11986,8809,210587,202964,162337,179549,170183,13108,9236,155661,144843,60323,93666,110807,14750,11231,116831,143136]),
  },
  '구글 SA': {
    leads: pad31([7,1,3,2,5,5,3,0,2,2,3,2,7,4,3,2,5,5,4,8,2]),
    clicks: pad31([30,40,16,57,63,48,34,24,47,39,18,52,73,35,38,40,42,51,42,63,32]),
    impressions: pad31([552,947,589,1213,1292,1451,633,1000,1060,830,805,1281,1529,1098,830,1108,1052,1197,1018,1314,728]),
    spend: pad31([80924,59920,35004,110305,93880,127947,80171,46634,83599,71884,32671,75974,121334,69007,87526,89645,82032,68994,103128,162378,85129]),
  },
  'YouTube AD': {
    leads: pad31([0,3,0,3,1,1,1,1,2,4,2,1,2,1,2,3,2,1,1,1,1]),
    clicks: pad31([36,46,32,35,41,26,36,35,37,37,46,48,32,23,26,29,32,20,31,25,24]),
    impressions: pad31([4652,5045,5786,5286,5150,5738,5050,4880,4967,5153,4660,4615,4044,4384,3859,4399,4015,3973,3616,3910,4066]),
    spend: pad31([19725,20472,22409,19549,19586,21398,19409,20241,19498,21070,20160,20322,20372,19790,19735,19966,19858,19783,19778,20055,18986]),
  },
  '틱톡': {
    leads: pad31([0,3,2,2,1,2,0,1,2,1,1,0,1,1,5,1,3,0,2,2,2]),
    clicks: pad31([0,18,21,27,19,23,19,24,24,17,18,22,19,21,25,14,15,18,21,18,21]),
    impressions: pad31([0,1741,2973,2882,2208,3347,2548,2823,3505,2328,2691,2752,2770,2808,2834,2541,3156,2956,2705,3336,2895]),
    spend: pad31([0,23313,36510,29385,28403,37500,28715,28474,33069,27233,25807,30090,30287,34175,34607,27272,26910,26623,29737,33246,29312]),
  },
};

export const REVENUE_SOURCE_RAW: SourceMap = {
  '메타': { revenue: pad31([541040,970987,414753,397400,429761,547150,209400,462000,507710,626703,150500,628700,1091883,1990206,790009,377870,256200,56800,0,430900,446500]), spend: pad31([104759,96933,106444,108516,123420,143572,134849,158088,155466,131749,117837,151629,207203,235498,163906,119109,94843,0,0,125239,163303]) },
  '네이버': { revenue: pad31([474500,643900,105900,160000,107800,249700,92900,407800,287800,653900,0,749700,538900,992400,342100,96000,157600,146900,343600,197900,303900]), spend: pad31([41372,34201,21212,28689,40811,38573,34664,40735,89295,34345,29567,61212,100942,82952,37368,31235,19248,19193,23106,20544,27865]) },
  'GFA': { revenue: pad31([34900,32000,0,64000,0,136800,0,32000,151800,32000,0,0,0,32000,91900,64000,0,0,0,32000,0]), spend: pad31([53883,57786,37372,0,0,52257,53063,48877,46304,45829,0,0,52399,51893,58608,39992,33643,0,0,50805,51126]) },
  '카카오키워드': { revenue: pad31([0,109000,0,0,0,0,149934,0,0,261000,0,348600,296100,547800,0,33540,0,0,0,0,162304]), spend: pad31([140,1400,710,0,1120,0,140,70,1220,210,210,280,420,1400,350,0,70,0,0,1070,210]) },
  '카카오모먼트': { revenue: pad31([]), spend: pad31([]) },
  '모비온': { revenue: pad31([0,64000,32000,0,0,0,0,0,0,0,0,249000,32000,262500,0,0,0,32000,0,0,81152]), spend: pad31([18375,32279,17320,15088,12637,15508,9330,11908,10907,10853,12567,10008,11841,12907,13284,13955,8611,9252,13851,12752,15994]) },
  'ADN': { revenue: pad31([276940,270000,250000,48000,45800,175900,138967,207600,91900,29000,30900,96301,299630,516011,160787,161500,120451,0,91200,58900,59800]), spend: pad31(Array(21).fill(30000)) },
  '구글': { revenue: pad31([0,0,0,0,0,0,0,14900,28160,39900,19900,38000,0,81411,0,0,0,0,0,0,0]), spend: pad31([0,0,0,0,0,40048,39566,39480,39190,39311,26203,20077,20044,20125,16488,0,0,0,0,0,0]) },
  '간접전환': { revenue: pad31([2307320,88713,520747,93000,181239,-19450,389099,268100,388730,-351403,364800,1530399,1619887,2909472,904904,135190,253749,86000,452100,106900,-196656]) },
  '카페24': { revenue: pad31([3535800,2146600,1323400,698400,736600,953300,843500,1300500,1304300,1259100,451200,3605800,3746700,7200100,2137900,684300,756000,238700,790900,854500,857000]) },
  '스마트스토어': { revenue: pad31([98900,32000,0,64000,28000,136800,136800,91900,151800,32000,114900,34900,131700,131700,151800,183800,32000,83000,96000,-27900,0]) },
};

export const CLICK_SOURCE_RAW: SourceMap = {
  '메타': { clicks: pad31([691,962,877,968,1255,1065,1303,889,953,1083,1130,1281,1160,1079,1067,1005,1130,1124,1214,1102,1112]), spend: pad31([158997,177617,145221,144845,185457,188497,220862,169773,178199,193211,194047,217363,206699,197504,186662,186878,199671,186039,216297,197981,193331]) },
  '네이버': { clicks: pad31([26,20,28,36,18,38,42,23,24,23,24,15,31,25,33,27,19,29,23,31,35]), spend: pad31([101830,45052,107724,129052,59383,114303,88038,95929,173884,134090,75841,54777,112823,96926,194806,107394,85057,90100,66095,93719,119985]) },
  '구글': { clicks: pad31([]), spend: pad31([0,0,0,0,0,0,0,0,0,19,0,13,0,0,0,0,0,0,0,0,1]) },
  '카카오모먼트': { clicks: pad31([73,73,73,74,73,73,73,131,0,78,146,150,165,251,251,172,161,86,0,160,168]), spend: pad31([54750,54750,54750,55500,54750,54750,54750,224536,0,61338,98854,99442,100394,146141,147346,99923,99593,56178,0,100234,99323]) },
  'GFA': { clicks: pad31([231,9,354,202,0,420,469,433,365,378,356,390,378,371,368,357,64,0,0,333,364]), spend: pad31([58021,2108,89909,45020,0,97052,88145,90268,88461,88140,90173,89046,91130,88462,94413,90275,14448,0,0,88336,89759]) },
  '당근': { clicks: pad31([57,52,50,58,60,58,49,56,55,56,66,65,60,56,54,58,66,68,68,65,66]), spend: pad31([30410,30174,29426,30577,30927,30463,26960,29422,30254,30369,30674,30395,30273,30715,30981,30837,30518,31279,28858,30581,31153]) },
};
...
export const REACH_SOURCE_RAW: SourceMap = {
  '메타': { impressions: pad31([28706,26496,27479,26440,37050,29900,25690,23030,25770,28010,29510,36020,28860,28420,27130,26410,28250,24410,34010,30150,30270]), spend: pad31([168237,166837,162485,159521,184958,173742,169071,168742,164426,165914,162524,184556,176151,169215,165093,165957,170088,157781,182666,173975,169373]) },
  'YouTube AD': { impressions: pad31([46520,50450,57860,52860,51500,57380,50500,48800,49670,51530,46600,46150,40440,43840,38590,43990,40150,39730,36160,39100,40660]), spend: pad31([119725,120472,122409,119549,119586,121398,119409,120241,119498,121070,120160,120322,120372,119790,119735,119966,119858,119783,119778,120055,118986]) },
  '카카오모먼트': { impressions: pad31([54750,54750,54750,55500,54750,54750,54750,224536,0,61338,98854,99442,100394,146141,147346,99923,99593,56178,0,100234,99323]), spend: pad31([54750,54750,54750,55500,54750,54750,54750,224536,0,61338,98854,99442,100394,146141,147346,99923,99593,56178,0,100234,99323]) },
  GFA: { impressions: pad31([58021,21080,89909,45020,20000,97052,88145,90268,88461,88140,90173,89046,91130,88462,94413,90275,44480,20000,20000,88336,89759]), spend: pad31([58021,2108,89909,45020,0,97052,88145,90268,88461,88140,90173,89046,91130,88462,94413,90275,14448,0,0,88336,89759]) },
  '네이버': { impressions: pad31([166390,152550,136470,88040,355470,249770,188790,179750,153230,130240,92200,83880,148840,145720,186910,137440,113080,86890,94340,149750,148470]), spend: pad31([188603,131408,160529,119860,88090,210587,202964,162337,179549,170183,131080,92360,155661,144843,60323,93666,110807,147500,112310,116831,143136]) },
};
...
export function sourceFor(type: ReportType, advertiserName?: string): SourceMap {
  if (type === 'revenue') return REVENUE_SOURCE;
  if (type === 'click') return CLICK_SOURCE;
  if (type === 'reach') return REACH_SOURCE;
  if (type === 'custom' || type === 'integrated') return COMBINED_SOURCE;
  return LEAD_SOURCE;
}
