...
describe('sumRows', () => {
  ...
  it('빈 배열이면 모든 값이 0이다', () => {
    const total = sumRows([]);
    expect(total).toEqual({ spend: 0, impressions: 0, clicks: 0, leads: 0, purchases: 0, unconfirmed: 0, addToCart: 0, completeRegistration: 0, revenue: 0, validLeads: 0, contracts: 0, platformLeads: 0 });
  });
