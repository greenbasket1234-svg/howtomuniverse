...
export const universeMenuGroups: UniverseMenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'blog-writing', label: '블로그 작성', path: '/content/blog', icon: 'folder' },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'blog-automation', label: '블로그 자동 생성', path: '/planned/blog-automation', icon: 'automation-rules', planned: true },
